...
function getColorClass(colorName, isDark, variant) {
    const colorMap = {
...
function FloatingParticle({ particle, isDark }) {
...
function AnimatedMeshGradient({ isDark }) {
    return (
...
export function ParticleBackground({ showRings = false }) {
