...
// Clone layout structure from wobo.ai/ai-job-application
// ============================================

// ─── Hero Section ───────────────────────────────────
function AIJobApplicationHero() {
    return (
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    >
                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-[#1C252E] dark:text-white leading-[1.15] mb-6">
                            <span className="block">Bot tự động ứng tuyển</span>
                        ...
                        <p className="text-lg md:text-xl text-[#637381] dark:text-[#C4CDD5] leading-relaxed mb-8 max-w-xl">
                            Chuyển đổi cách tìm việc của bạn với bot ứng tuyển tự động bằng AI của SmartHire.
                            Chúng tôi tìm kiếm các cơ hội tốt nhất cho bạn và nộp đơn ứng tuyển thay bạn,
                            đảm bảo mỗi đơn ứng tuyển đều được cá nhân hóa và chuyên nghiệp nhất kể cả khi bạn đang ngủ.
                        </p>
                    ...
                    >
                        <img
                            src="/assets/images/ai-job-application/hero.png"
                            alt="AI Job Application Bot"
                            width={520}
                            height={420}
...
// ─── Main Export ─────────────────────────────────────
export function AIJobApplicationPage() {
    return (
        <>
            <AIJobApplicationHero />
            <StepsSection />
