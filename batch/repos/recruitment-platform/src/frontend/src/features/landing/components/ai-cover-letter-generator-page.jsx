...
// ============================================
// AI COVER LETTER GENERATOR PAGE — SmartHire Design System
// Reusing structure from AI Job Application
// ============================================

// ─── Hero Section ───────────────────────────────────
function AICoverLetterHero() {
    return (
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    >
                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-[#1C252E] dark:text-white leading-[1.15] mb-6">
                            <span className="block text-3xl sm:text-4xl text-[#1C252E]/70 dark:text-white/70 font-medium mb-1">Cá nhân hóa</span>
                            <span className="block">Trình tạo Thư xin việc AI</span>
                            <span className="block mt-1 bg-gradient-to-r from-[#22c55e] via-[#10b981] to-[#FFAB00] bg-clip-text text-transparent">
                                phù hợp mọi tin tuyển dụng
                            </span>
                        </h1>

                        <p className="text-lg md:text-xl text-[#637381] dark:text-[#C4CDD5] leading-relaxed mb-8 max-w-xl">
                            Tạo một bức thư xin việc cá nhân hóa chỉ trong 30 giây. Trình tạo bằng AI của SmartHire sẽ nắm bắt các kỹ năng hiện có của bạn và ghép nối hoàn hảo với bản mô tả công việc (JD), giúp bạn dễ dàng thuyết phục nhà tuyển dụng ngay từ cái nhìn đầu tiên.
                        </p>
                    ...
                    >
                        <img
                            src="/assets/images/ai-cover-letter-generator/hero.png"
...
function FeaturesDetailSection() {
    const features: FeatureData[] = [
        ...
        },
        {
            ...
            description: "Tò cho muốn biết chúng tôi đã nộp đơn thay bạn ở đâu? Truy cập toàn bộ chi tiết ứng tuyển — từ mô tả công việc, các câu trả lời đã nộp, đến CV và Thư xin việc đã được sử dụng — để bạn luôn nắm rõ tiến trình.",
...
// ─── Main Export ─────────────────────────────────────
export function AICoverLetterGeneratorPage() {
    return (
        <>
            <AICoverLetterHero />
            <StepsSection />
