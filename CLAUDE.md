...
- `CLAUDE.md`, `*.mjs` scripts (specifically `src/github/profile-builder.mjs` which acts as our Advanced Deep Scan engine for discovering Git Hygiene and Architectural patterns), `dashboard/*`, `templates/*`, `batch/*`
